    ...
    var method = {
        ...
        pagingHtml:function(){
            ...
            if(me.isShowPrePageBtn){
                html.push('<li class="pn-prev '+(me.hasPrv ? '' : 'disabled')+'" title="'+me.lang.prePageText+'">&lt; 上一页</li>');
            }
            ...
            if(me.isShowNextPageBtn){
                html.push('<li class="pn-next '+(me.hasNext ? '' : 'disabled')+'" title="'+me.lang.nextPageText+'">下一页 &gt;</li>');
            }
            html.push('</ul>');
