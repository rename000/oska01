...
<%
    ...
    if("".equals(newsId) || "null".equals(newsId) || newsId == null){
        newsId = "1";
    }
...
<div class="content">
    <div class="w">
        <div class="mbx">您当前位置：<a href="javascript:;">首页</a> - <a href="javascript:;">新闻资讯</a> -
            <%=("1".equals(newsType)?"企业新闻":"")%>
            <%=("2".equals(newsType)?"行业新闻":"")%>
        </div>
        <div class="news-detail">
            ...
            <em class="box font14" id="newsDesc" style="min-height: 300px;">
