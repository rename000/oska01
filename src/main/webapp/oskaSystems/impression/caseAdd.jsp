...
<ul class="breadcrumb no-border no-radius b-b b-light pull-in">
    ...
    <li class="active"><a href="#">新增案例</a></li>
</ul>
...
<section class="panel panel-default add-b-t" style="min-width: 1000px;overflow: auto;">
    ...
    <div class="a-content">
        ...
        <!-- 项目基本资料 -->
        <header class="h4 text-left padder padder-v m-b"><strong>新增案例</strong></header>

        <row class="dis-table padder m-b m-l-40">
            <label class="t-cell in-name in-v-m">案例名称：</label>
            <div class="t-cell in-input in-w-200"><input type="text" id="caseName" class="form-control" placeholder="请填写案例名称" value=""></div>
        </row>

        <row class="dis-table padder m-b m-l-40">
            <label class="t-cell in-name in-v-t">案例图片：</label>
